...
internal class PatchHelperWithMyerDiffWithLinearSpaceTest {
    ...
    fun testPatch_Change_withExceptionProcessor() {
        ...
        val patch = patchHelper.generate(from, to, algorithm = DiffAlgorithm.Factory.createMyersLinearSpace())
        from[2] = "CDC"
